...
function renderAdmin(lista) {
  ...
  lista.forEach(c=>{
    ...
    rows+='<tr>'+
      ...
      '<td><button onclick="abrirCliente(''+c.id+'')" style="background:none;border:1px solid rgba(255,255,255,.15);color:#7a7875;padding:4px 10px;border-radius:5px;cursor:pointer;font-size:11px">Gestionar</button></td>'+
      '</tr>';
  });
